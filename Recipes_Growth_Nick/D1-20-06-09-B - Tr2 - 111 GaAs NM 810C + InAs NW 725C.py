...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_Anneal_Manip = 820  # Desired manip temperature (pyro is broken)
        T_GaAs_Manip = 810  # Desired manip temperature (pyro is broken)
        T_InAs_Manip = 725  # Desired manip temperature for InAs growth
