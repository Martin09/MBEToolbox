...
###########################
rate_ga = 0.5  # A/s - Will calculate cell temp from this based on latest RHEED/BFM calibrations
p_as_gaas = 7.2E-6  # Torr - Will calculate valve opening from this based on latest BFM calibrations
###########################
...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        t_growth_gaas = 45 * 60  # 30 minutes
        ...
        mbe.set_param("AsCracker.Valve.OP", 20)
