...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        t_predep = 1 * 60  # 1 minute Ga predeposition
        t_growth_gaas = 40 * 60  # 30 minutes
        ...
        # ts_print("Starting Ga Predeposition")
        # mbe.shutter("Ga", True)
        # mbe.waiting(t_predep)
        # mbe.shutter("Ga", False)
        # ts_print("Predeposition Finished")
