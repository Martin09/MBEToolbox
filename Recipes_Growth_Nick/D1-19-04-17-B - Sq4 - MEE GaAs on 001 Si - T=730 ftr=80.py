...
#Testing effect of higher growth rate, keeping V/III ratio fixed
###########################
rate_ga = 0.33  # A/s - Will calculate cell temp from this based on latest RHEED/BFM calibrations
p_as_gaas = 1.2E-5  # Torr - Will calculate valve opening from this based on latest BFM calibrations
###########################
...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_Ga = 907  # Matched to Martins Recipe D1-19-04-08-A (1.5E-7)
        ...
        t_growth_gaas = 45 * 60  # 60 minutes
