...
p_as_gaas = 5E-6  # Torr - Will calculate valve opening from this based on latest BFM calibrations
###########################
...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        t_growth_gaas = 50 * 60  # 50 minutes
        ...
        ts_print("Going to GaAs nucleation conditions, setting manip to {}".format(T_Des_GaAs_Manip))
