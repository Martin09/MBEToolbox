...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_Ga_Shell = calib_Ga.calc_setpoint_gr(rate_ga_shell)  # 1.0 A/s growth rate
        ...
        t_growth_gaas_dop = thickness_dop * 10. / GR_gaas_shell  # sec
        t_growth_gaas_bar = thickness_barrier * 10. / GR_gaas_shell  # sec
