...
if __name__ == '__main__':
    ...
    calib_As = Calibration("As", filename='2017-05-09_09-18-29_As.txt')
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_Des_GaAs_Manip = 747.8  # Desired manip temperature (pyro is broken)
        T_Des_InAs_Manip = 639  # Desired manip temperature for InAs growth
        ...
        t_growth_inas = 300  # 200 seconds (4nm)
        Si_current = 40  # 40A
