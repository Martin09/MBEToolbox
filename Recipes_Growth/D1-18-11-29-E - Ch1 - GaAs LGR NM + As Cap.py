...
# 11-23-C - Commented out InAs growth part to just grow the GaAs buffers. Will As cap this after.
# 11-29-E - Repeating 23-C using same holder as in 23-A. 23-C growth didn't look so nice (some parasitic).
###########################
rate_ga = 0.3  # A/s
