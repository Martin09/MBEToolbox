"""
Made the annealing step longer and higher temp to try and smoothen out bottoms of large slits.
Physics etching and dose test!
Growth recipe for nanomembranes with InAs nanowires on top. No Doping!
Requires the new MBE_Toolbox

Triangle holder. Last time temps seemed too low, trying to bump up temps by 60 degrees.
No Doping!
Manipulator might have bearing problem, therefore turning at "-7 rpm" instead of +7.
ie: 750/650 to 810/710
"""
...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_Des_Anneal_Manip = 830  # Desired manip temperature (pyro is broken) *20deg higher than GaAs growth*
        T_Des_GaAs_Manip = 810  # Desired manip temperature (pyro is broken)
        T_Des_InAs_Manip = 710  # Desired manip temperature for InAs growth
        ...
        t_growth_inas = 300  # 200 seconds (6nm)
        # Si_current = 10  # 40A
