"""
Trial growth of 4 nanowires on top of the membrane. Lower As pressure should give two triangular NWs and 111 top surf.
Second GaAs growth step should give pointy top again, second InAs NW growth should give two more triangular NWs.
In total, 4 InGaAs nanowires on top of the NM.
No doping used.
Recipe modified from D1-17-09-01-E and idea taken from FIB cross sections on this sample.
...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        t_growth_gaas = 30 * 60  # 30 minutes (~300nm tall)
        t_growth_gaas2 = 1 * 60  # 30 minutes (~10nm thick)
        t_growth_inas = 600  # 600 seconds (12nm)
        Si_current = 40  # 40A
