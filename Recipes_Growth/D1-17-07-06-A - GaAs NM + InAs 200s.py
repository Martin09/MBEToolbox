...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_LT_Ga = calib_Ga.calc_setpoint_gr(1.0)  # 1.0 A/s growth rate
        T_LT_In = calib_In.calc_setpoint_gr(0.1)  # 0.2 A/s growth rate
        ...
        ##############################################################################
        # Grow low temperature GaAs cap
        ##############################################################################

        # TODO: write this!
        # Use only max 1-2 nm InGaAs marker!
