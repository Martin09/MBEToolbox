...
if __name__ == '__main__':
    ...
    calib_As = Calibration("As", filename='2017-03-10_10-25-45_As.txt')
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_Des_InAs = 530  # Desired pyrometer temperature for InAs growth
        ...
        Si_current = 20  # 40A = 2.1E20 cm-3
        anneal_time = 60 * 20  # 20min anneal time
        ...
        mbe.timer_wait(anneal_time)  # Wait during anneal
