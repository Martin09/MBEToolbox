...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server, scriptname=os.path.basename(__file__)) as mbe:
        ...
        p_as_gaas = 1.5E-6  # Desired As pressure for GaAs growth, 4E-6 originally but changed to compensate low Ga pressure (4*0.7)
        ...
        # Using very low As pressure, so don't do this check
