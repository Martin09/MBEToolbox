...
# 18-10-05-A - First chip from second half of the substrate.
# Commented out AlGaAs shell parts, just want to check if we have 111A nanowires on this half of the substrate
...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        t_growth_gaas = 1 * 60 * 60  # 60 minutes
