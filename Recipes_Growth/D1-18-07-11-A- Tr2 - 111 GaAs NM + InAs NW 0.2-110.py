...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        #Using Tr2 holder!
        T_Des_Anneal_Manip = 805 #760  # Desired manip temperature (pyro is broken)
        T_Des_GaAs_Manip = 805 #750  # Desired manip temperature (pyro is broken)
        T_Des_InAs_Manip = 685 #640  # Desired manip temperature for InAs growth
