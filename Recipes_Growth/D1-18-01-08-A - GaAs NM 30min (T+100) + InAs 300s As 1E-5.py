...
Second growth with new triangle holder. Last time temps seemed too low, trying to bump up temps by 50 degrees.
ie: 750/650 to 800/700
"""
...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_Des_Anneal_Manip = 805  # Desired manip temperature (pyro is broken)
        T_Des_GaAs_Manip = 850  # Desired manip temperature (pyro is broken)
        T_Des_InAs_Manip = 750  # Desired manip temperature for InAs growth
