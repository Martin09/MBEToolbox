...
# TODO: Rewrite this as ...with MBERecipe(virtual_server=run_virtual_server) as mbe:
# TODO: Make material case insensitive
# Short calibration
...
if __name__ == '__main__':
    ...
    if mat.lower() == 'sb':
        valve = SbValve(COM=2)
        if not valve.working:
            ts_print("Cannot establish connection with Sb valve, exiting...")
            connection.close()
            exit()
    else:
        valve = None
