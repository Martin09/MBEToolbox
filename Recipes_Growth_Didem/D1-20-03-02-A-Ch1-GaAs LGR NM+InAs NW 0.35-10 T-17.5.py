...
# Chip ID: 000045672835. Pattern has large slits. Preparing for Kris, since he got high mobilities on similar substrate
...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_InAs_Manip = 642.5  # Desired manip temperature for InAs growth
    ...
    ##############################################################################
    ts_print('Plotting Recipe Parameters')
    ...
    if run_growth['GaAs_passivation_layer']:
        ...
        file.write("T_Ga during GaAs passivation layer: {:.0f} degC \n".format(T_Ga_Shell))
        file.write("p_as_gaas: {:.2e} Torr\n".format(p_as_shell))
