...
if __name__ == '__main__':
    calib_In = Calibration("In", filename="2019-03-18_12-42-50_In.txt", rheed_filename="2017-06-30_In.txt")
    calib_Ga = Calibration("Ga", filename="2019-04-12_17-07-59_Ga.txt", rheed_filename="2017-06-30_Ga.txt")
