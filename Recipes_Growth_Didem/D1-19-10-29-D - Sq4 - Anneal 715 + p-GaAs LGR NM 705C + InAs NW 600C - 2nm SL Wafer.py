...
# Similar to D1-19-07-05-A (Martin's growth)
# D1-19-10-17-A Changed the GaAs growth time. (increased)
#D1-19-10-20-A Decreased the growth temperature for InAs growth. When we increase it doesnt help. Lets try to decrease.
# Wafer I prepare for Kris
###########################
rate_ga = 0.3  # A/s
...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_GaAs_Manip = 705  # Desired manip temperature (pyro is broken)
        T_InAs_Manip = 600  # Desired manip temperature for InAs growth
