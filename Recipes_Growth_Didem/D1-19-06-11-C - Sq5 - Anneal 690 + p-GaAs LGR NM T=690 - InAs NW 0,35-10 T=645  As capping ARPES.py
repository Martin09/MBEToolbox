...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_Anneal_Manip = 690  # Desired manip temperature (pyro is broken)
        T_GaAs_Manip = 690  # Desired manip temperature (pyro is broken)
        T_InAs_Manip = 645  # Desired manip temperature for InAs growth
        ...
        mbe.as_capping()  # Cap the sample with arsenic
