...
# Same with the D1-19-06-27-A GaAs NM growth with longer times. We did the BFM calibration. I changed the calibration temperature

###########################
rate_ga = 0.3  # A/s
ftr_gaas = 80  # five three ratio
rate_in = 0.35  # A/s
ftr_inas = 20  # five three ratio
...
if __name__ == '__main__':
    ...
    calib_Ga = Calibration("Ga", rheed_filename="2017-06-30_Ga.txt", filename="2019-04-12_17-07-59_Ga.txt")
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_GaAs_Manip = 780  # Desired manip temperature (pyro is broken)
        T_InAs_Manip = 680  # Desired manip temperature for InAs growth
        T_GaAs_Shell_Manip = 660  # Desired manip temperature for GaAs
        # shell growth
