...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        print("T_Ga_shell: {:.2f}s".format(T_Ga_Shell))
        print("T_In_marker: {:.2f}s".format(T_In_marker))
        ...
        if run_growth['GaAs_Membrane_Growth']:
            ...
            mbe.shutter("Ga", True)
            mbe.waiting(t_growth_gaas - t_growth_dop -t_growth_ingaas - 2*t_growth_barrier)  # Wait Growth Time
            mbe.shutter("In", True)
