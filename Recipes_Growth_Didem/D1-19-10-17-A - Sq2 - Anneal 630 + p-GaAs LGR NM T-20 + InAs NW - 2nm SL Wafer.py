...
# Changed the GaAs growth time. (increased)
...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_GaAs_Manip = 715  # Desired manip temperature (pyro is broken)
        T_InAs_Manip = 615  # Desired manip temperature for InAs growth
