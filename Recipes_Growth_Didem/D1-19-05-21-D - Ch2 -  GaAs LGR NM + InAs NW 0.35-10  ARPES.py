"""
Example of a growth recipe for Si doped nanomembranes with InAs nanowires on top with As capping at the end
...
# Based on D1-17-01-17-B, we add passivation layer on top of InAs
# Si doped membranes D1-17-01-17-B
# InAs growth conditions : same D1-19-05-02-C
...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_GaAs_Manip = 760  # Desired manip temperature (pyro is broken)
        ...
        mbe.waiting(20*60) #We wait 20 min for Si cell to be stabilized (in total 30 min is necessary)
