...
# 02-C: Added 10 nm of blocking GaAs blocking layer (at 450) after InAs and InGaAs layers
# Same with the 2C- Only we grow shell at low temperature (450)
# This sample:  After InGaAs NW growth, shell only consists of GaAs and it is grown at 450C
###########################
rate_ga = 1.0  # A/s
...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_Shell_Manip = 450  # 200 deg lower than GaAs NM growth
        ...
        ts_print("Going to GaAs shell growth conditions, setting manip to {}".format(T_Shell_Manip))
        mbe.set_param("Manip.PV.Rate", 30)
