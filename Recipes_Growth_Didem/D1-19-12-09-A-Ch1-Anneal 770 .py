...
run_growth ={'Annealing':True,
             'GaAs_Membrane_Growth':False,
             'InAs_NW_Growth':False,
             'GaAs_passivation_layer':False}

# Chip ID: 000045672840 wo metal AMs.
...
if __name__ == '__main__':
    ...
    ##############################################################################
        ...
        file.write("T_Ga_shell manipulator during GaAs membrane growth: {:.0f} deg C\n".format(T_GaAs_Shell_Manip))
        file.write("p_as_gaas: {:.2e} Torr\n".format(p_as_gaas_shell))
        file.write(("as_valve_gaas: {:.2f}%\n".format(as_valve_gaas_shell)))
