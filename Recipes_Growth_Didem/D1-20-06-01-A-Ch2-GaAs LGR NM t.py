...
# Chip ID:000045672848


###########################
rate_ga = 0.3  # A/s
ftr_gaas = 40  # five three ratio
rate_in = 0.35  # A/s
...
if __name__ == '__main__':
    ...
    if run_growth['Annealing']:
        ...
        file.write("As valve opening during annealing: {:.1f}s\n\n".format(as_valve_annealing))
        file.write("As pressure during annealing: {:.1f}s\n\n".format(p_as_annealing))
