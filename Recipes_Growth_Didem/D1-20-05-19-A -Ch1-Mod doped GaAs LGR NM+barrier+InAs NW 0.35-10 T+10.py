...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_Ga_Shell = calib_Ga.calc_setpoint_gr(rate_ga)  # Ga shell temp
        ...
        thickness_growth_barrier_low = 8
        t_growth_barrier_low=thickness_gaas_barrier*10 / rate_ga_shell
        ...
        if run_growth['GaAs_Membrane_Growth']:
            ...
            mbe.shutter("Ga", True)
            mbe.waiting(t_growth_gaas - t_growth_dop -t_growth_ingaas - 2*t_growth_barrier-t_growth_barrier_low)  # Wait Growth Time
            mbe.shutter("In", True)
