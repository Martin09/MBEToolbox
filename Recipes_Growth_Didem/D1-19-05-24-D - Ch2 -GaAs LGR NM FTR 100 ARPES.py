"""
Example of a growth recipe for nanomembranes without InAs nanowires on top to see GaAs underneath
Requires the new MBE_Toolbox
"""
from recipe_helper import MBERecipe, ts_print
from mbe_calibration import Calibration

# D1-19-05-24-D: Same as 04-23-B but lowered growth temp by 10 degrees and increased FTR from 80 to 100.

run_virtual_server = False
use_pyro = False

# Repeat of D1-18-10-19-D
###########################
rate_ga = 0.3  # A/s
ftr_gaas = 100  # five three ratio
#rate_in = 0.35  # A/s
...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_GaAs_Manip = 740  # Desired manip temperature (pyro is broken)
