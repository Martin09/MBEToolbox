"""
Since I use the square holder, heat conductance is higher than chip holders. I lowered the temperatures of the manipulator, by 40 degrres for all processes.
