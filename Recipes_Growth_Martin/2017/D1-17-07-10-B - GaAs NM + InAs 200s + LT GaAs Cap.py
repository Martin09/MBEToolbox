...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_Des_LTGaAs_Manip = 445  # Desired manip temperature for low temperature GaAs growth
        p_as_gaas = 4E-6  # Desired As pressure for GaAs growth
        p_as_inas = 8E-6  # Desired As pressure for InAs
        ...
        mbe.wait_to_reach_temp(T_Des_LTGaAs_Manip, error=1)

        mbe.waiting(5 * 60)  # Wait five minutes to stabilize temperature
