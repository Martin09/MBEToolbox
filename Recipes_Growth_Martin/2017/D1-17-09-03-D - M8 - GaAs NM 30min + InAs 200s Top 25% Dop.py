...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        mbe.shutter("In", True)
        mbe.waiting(int(t_growth_inas*0.75))  # Wait 75% of Growth Time
        ts_print("Opening Si shutter")
        mbe.shutter("SUSI", True)		
        mbe.waiting(int(t_growth_inas*0.25))  # Wait last 25% of Growth Time
        ts_print("Closing In+Si shutter")
