...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_Des_InAs = 550  # Desired pyrometer temperature for InAs growth
        ...
        mbe.wait_to_reach_temp(300, error=3)  ts_print("Temperature reached 300, closing As valve and shutter")
