...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_Anneal_Manip = 735  # Desired manip temperature (pyro is broken)
        T_GaAs_Manip = 735  # Desired manip temperature (pyro is broken)
        T_InAs_Manip = 620  # Desired manip temperature for InAs growth
        T_GaAs_Shell_Manip = 620  # Desired manip temperature for GaAs shell growth
