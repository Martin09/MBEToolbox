...
# 19-06-17-B: Repeat with different holder, last time has some parasitic deposition at edge of substrate
# 18-B: Repeat as 17-B + As cap at end
###########################
Rate_In = 0.2  # A/s
...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        # Using Tr2 holder!
        T_Des_Anneal_Manip = 760  # 760  # Desired manip temperature (pyro is broken)
        T_Des_GaAs_Manip = 750  # 750  # Desired manip temperature (pyro is broken)
