...
# 10-03-B - Repeat of this recipe on new wafer, using As cracker at 600 instead of 950
# 10-08-D - Increased growth rate to 1.0 A/s and thickness to 200nm. Commented out InAs growth.
# 10-21-B - Trying again since Ga shutter was stuck last time...
###########################
rate_ga = 1.0  # A/s
...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_GaAs_Manip = 710  # Desired manip temperature (pyro is broken)
