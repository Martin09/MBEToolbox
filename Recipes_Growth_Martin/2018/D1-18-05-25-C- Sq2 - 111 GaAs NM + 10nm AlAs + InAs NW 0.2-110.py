...
# AlAs Barrier + InGaAs Nanowire Growth
###########################
rate_al_shell = 0.284  # A/s
ftr_shell = 110  # five three ratio
...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        p_as_shell = calib_Al.calc_p_arsenic(rate_al_shell, ftr_shell)  # Desired As pressure for AlAs growth
        ...
        thickness_alas_shell = 10  # nm
        GR_alas_shell = rate_al_shell  # Assume growth rate is equal to 2D layer GR
