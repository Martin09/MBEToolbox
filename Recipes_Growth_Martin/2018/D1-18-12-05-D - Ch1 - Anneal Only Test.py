...
# Just an annealing test. Want to test if the GaAs surface in the slits is consumed during annealing step
# Some SEM images from D1-18-12-04-B seemed to suggest that this is the case!
# 11-30-D - Growing for half the time, reverted to old calibration files
# 12-05-X - Commented out all the growth parts after the annealing step
###########################
# rate_ga = 0.3  # A/s
