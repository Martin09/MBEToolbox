...
# Based on D1-19-04-03-A, added 3nm GaAs passivation layer on top of InAs
# Shell conditions: same temps + large As opening for shell growth, 5nm thick.
# D1-19-04-09-E: decreased shell capping temp from 660 to 550
# D1-19-04-18-D: Repeat of 09-E since Ga shutter had fallen off for that growth!
###########################
rate_ga = 0.3  # A/s
...
if __name__ == '__main__':
    ...
    with MBERecipe(virtual_server=run_virtual_server) as mbe:
        ...
        T_GaAs_Shell_Manip = 550  # Desired manip temperature for GaAs shell growth
